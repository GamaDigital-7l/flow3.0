...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="page-content-wrapper space-y-0"> {/* Removed vertical spacing here, will apply inside the padded container */}
      ...
      <div className="max-w-7xl mx-auto px-3 md:px-4 lg:px-6 space-y-6">
        <div className="flex justify-between items-center flex-wrap gap-2 pt-4"> {/* Added pt-4 for spacing after the full-width reminder */}
          <div>
